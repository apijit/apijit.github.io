angular.module('app', ['chart.js', 'firebase'])
    ...
    .factory('Question', function () {
        var questions = [{
            ...
            id: 4,
            question: 'เวลาที่คุณแสดงความคิดเห็นกับคนอื่น คุณชอบ...',
            answers: [{
                text: 'ให้คนเห็นด้วยอย่างเป็นมติเอกฉันท์',
                value: 0
            }, {
                text: 'ให้คนเห็นคล้ายคลึงกับคุณ',
                value: 0.1
            }, {
                text: 'ให้คนแย้งพอสมควร',
                value: 0.5
            }, {
                text: 'ให้คนแย้งอย่างมีเหตุผล',
                value: 0.75
            }, {
                text: 'ให้คนแย้ง แม้ไม่ต้องมีเหตุผลก็ได้',
                value: 1
            }],
            category: 'wisdom',
            weight: 2
            ...
            answers: [{
                text: 'จากบางแหล่งในประเทศไทยที่เป็นภาษาไทย',
                value: 0
            }, {
                text: 'จากหลายๆแหล่งในประเทศไทยที่เป็นภาษาไทย',
                value: 0.25
            }, {
                text: 'จากหลายๆแหล่งในประเทศไทยที่เป็นภาษาไทยและภาษาต่างประเทศ',
                value: 0.75
            }, {
                text: 'จากหลายๆแหล่งทั่วโลกที่เป็นภาษาไทยและภาษาต่างประเทศ',
                value: 1
            }],
            category: 'wisdom',
            weight: 4
